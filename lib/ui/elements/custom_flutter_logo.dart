...
enum FlutterLogoStyleX {
  /// Show only Flutter's logo, not the "Flutter" label.
  ///
  /// This is the default behavior for [FlutterLogoDecorationX] objects.
  markOnly,
...
class FlutterLogoDecorationX extends Decoration {
  ...
  const FlutterLogoDecorationX({
    ...
    this.logo = null,
       ...
       assert(margin != null),
       assert(logo != null),
       _position = identical(style, FlutterLogoStyleX.markOnly) ? 0.0 : identical(style, FlutterLogoStyleX.horizontal) ? 1.0 : -1.0,
       // (see https://github.com/dart-lang/sdk/issues/26980 for details about that ignore statement)
       _opacity = 1.0;

  const FlutterLogoDecorationX._(this.lightColor, this.darkColor, this.textColor, this.style, this.margin, this._position, this._opacity, this.logo);
  ...
  static FlutterLogoDecorationX lerp(FlutterLogoDecorationX a, FlutterLogoDecorationX b, double t) {
    assert(t != null);
    ...
    if (a == null && b == null)
      return null;
    if (a == null) {
      return FlutterLogoDecorationX._(
        b.lightColor,
        b.darkColor,
        b.textColor,
        b.style,
  ...
  @override
  FlutterLogoDecorationX lerpFrom(Decoration a, double t) {
    assert(debugAssertIsValid());
    if (a == null || a is FlutterLogoDecorationX) {
      assert(a == null || a.debugAssertIsValid());
      return FlutterLogoDecorationX.lerp(a, this, t);
    }
    return super.lerpFrom(a, t);
  }

  @override
  FlutterLogoDecorationX lerpTo(Decoration b, double t) {
    assert(debugAssertIsValid());
    if (b == null || b is FlutterLogoDecorationX) {
      assert(b == null || b.debugAssertIsValid());
      return FlutterLogoDecorationX.lerp(this, b, t);
    }
  ...
  bool operator ==(dynamic other) {
    ...
    if (identical(this, other))
      return true;
    if (other is! FlutterLogoDecorationX)
      return false;
    final FlutterLogoDecorationX typedOther = other;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(EnumProperty<FlutterLogoStyleX>('style', style));
    if (_inTransition)
...
class _FlutterLogoPainter extends BoxPainter {
  Log log = new Log('FlutterLogoPainter');
  ...
  final FlutterLogoDecorationX _config;
